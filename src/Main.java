...
public class Main {
	...
	public static void main(String[] args) {
		...
		int p = 5;
		if (o > p)
			System.out.println("o is bigger than p");
		else
			System.out.println("o is not bigger than p");

		// else if statement
		int a = 10;
		int s = 5;
		if (a > s)
			System.out.println("a is bigger than s");
		else if (a == s)
			System.out.println("a is equal to s");
		else
			System.out.println("a is not bigger than s");
